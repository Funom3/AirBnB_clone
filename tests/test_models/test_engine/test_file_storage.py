...
class TestFileStorageInit(unittest.TestCase):
    ...
    def test_file_path_is_a_private_class_attr(self):
        """checks that the file_path is a private class attribute"""
        self.assertFalse(hasattr(FileStorage(), "__file_path"))

    def test_objects_is_a_private_class_attr(self):
        """checks that the object is a private class attribute"""
...
class Test_storageMethods(unittest.TestCase):
    """contains tests cases against the methods present in the FileStorage"""

    @classmethod
    def setUp(self):
        """this is the code to execute before testing occurs"""
        try:
    ...
    @classmethod
    def tearDown(self):
        """this is the code to execute after the test are executed"""
    ...
    def test_new_method(self):
        ...
        # what if more than one arg were passed to this?
        # TypeError, is needed here!
        with self.assertRaises(TypeError):
    ...
    def test_save_method(self):
        """check reload() method in the FileStorage class"""
        dummy_bm = BaseModel()
        dummy_user = User()
        dummy_state = State()
        dummy_city = City()
        ...
        # when arg is passed, TypeError is activated!
        with self.assertRaises(TypeError):
    ...
    def test_reload_method(self):
        ...
        # when arg is passed, raise TypeError
        with self.assertRaises(TypeError):
