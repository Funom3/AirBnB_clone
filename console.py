...
class HBNBCommand(cmd.Cmd):
    """the class that will implement the console
    for the AirnB web application"""
    prompt = "(hbnb) "
    ...
    def do_create(self, argv):
        ...
        the JSON fileand prints its id"""
    ...
    def do_destroy(self, argv):
        """deletes a class instance based on the name and a given id"""
    ...
    def do_update(self, argv):
        ...
        updating attribute and saving it to the JSON file"""
        arg_list = check_args(argv)
        if arg_list:
            if len(arg_list) == 1:
                print("** instance id missing **")
    ...
    def do_count(self, arg):
        """retrieve the number of the instances of a class"""
        arg1 = parse(arg)
        count = 0
